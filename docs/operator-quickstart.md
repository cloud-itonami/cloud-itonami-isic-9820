# Operator Quickstart — Undifferentiated Service-Producing Activities of Private Households for Own Use

Shortest path from clone to a verified local dry-run for **ISIC 9820** (`cloud-itonami-isic-9820`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9820.git
cd cloud-itonami-isic-9820
```
...
- Blueprint governor key: `time-use-programme-governor`
- Likely source path: `timeuseops.governor.cljc`
